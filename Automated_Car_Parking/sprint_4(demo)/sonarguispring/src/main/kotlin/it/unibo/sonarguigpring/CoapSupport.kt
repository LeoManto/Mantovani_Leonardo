...
class CoapSupport(address: String, path: String) {
    ...
    init { //"coap://localhost:5683/" + path
        ...
        val rep = readResource() //invoca readResource
    ...
    // sarà chiamato quando dovrò, in quanto spring application, farà l'update della risorsa.
    ...
    //viene updatata la risorsa , ciò avviene se vengono inviati dei valori dalla pagina web e quindi inviati dei sonardata.
