...
//spring crea e inietta i componeneti annotati come @controller
@Controller
class HIController {
    @Value("\${human.logo}")
    var appName: String?    = null

    //attenzione a cambiare questo IP in caso sia necessario
    //PORTA: deve essere la stessa su cui gira la risorsa!!!
    var coap    = CoapSupport("coap://192.168.1.134:8028", "ctxsonarresource/sonarresource")
    ...
    init{
        ...
        //coap observer viene agganciato al WebPageCoapHandler, per osservarlo.
...
*/
    //Ogni volta che qualcuno fa un POST con il pattern "/sonardata", prende i paramentri e fa un update dell'observer coap.
    ...
    //invia il valore del sonar alla risorsa, poi conpenso la latenza della GUI con la sleep.
        ...
        sysUtil.colorPrint("HIController | resRep:$resRep", Color.BLUE)
         ...
         return "sonarGui" //alla fine restituisce comunque la sonarGui (pag. HTML) così che l'utente possa continuare a usarla.
