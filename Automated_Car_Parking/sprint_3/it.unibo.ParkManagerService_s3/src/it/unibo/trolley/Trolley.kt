		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t018",targetState="path",cond=whenDispatch("move"))
				}	 
				...
				state("checkInterrupt") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t019",targetState="execPlannedMoves",cond=whenTimeout("local_tout_trolley_checkInterrupt"))   
					transition(edgeName="t020",targetState="path",cond=whenDispatch("move"))
				}	 
				...
				state("doMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t021",targetState="checkObstacle",cond=whenTimeout("local_tout_trolley_doMove"))   
				}	 
				state("checkObstacle") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t022",targetState="stepDone",cond=whenTimeout("local_tout_trolley_checkObstacle"))   
				...
				state("stepDone") { //this:State
					action { //it:State
						...
						updateResourceRep( "stepdone($CurrentPlannedMove)"  
						)
				...
				state("halt") { //this:State
					action { //it:State
						...
						itunibo.planner.plannerUtil.showCurrentRobotState(  )
						updateResourceRep( "finished($GOAL)"  
						)
