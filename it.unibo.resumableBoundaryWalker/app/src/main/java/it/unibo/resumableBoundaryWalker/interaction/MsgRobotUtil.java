...
public class MsgRobotUtil {
    ...
    public static final int wtime    = 200;
    ...
    //cril
    public static final String forwardMsg   = "{\"robotmove\":\"moveForward\", \"time\": 200}";
    public static final String backwardMsg  = "{\"robotmove\":\"moveBackward\", \"time\": 200}";
